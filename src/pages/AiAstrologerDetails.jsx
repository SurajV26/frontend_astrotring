    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-amber-50 to-white">
        <div className="text-center">
          ...
          <button onClick={() => navigate("/")} className="mt-4 px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600">Go Home</button>
        </div>
      </div>
    )
  }
        ...
        <div className="flex flex-col lg:flex-row gap-6 mb-8">
          ...
          <div className="flex-1">
            ...
            <div className="mt-6 flex flex-col md:flex-row items-center gap-4">
              ...
              {/* CHAT BUTTON */}
              <button className="w-full md:w-auto h-14 md:h-[70px] bg-gradient-to-r from-amber-500 to-orange-500 rounded-full text-gray-200 font-bold flex items-center justify-center gap-2 hover:from-amber-600 hover:to-orange-600 transition-colors px-8 md:px-10">
