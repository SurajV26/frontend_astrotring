  ...
  sections: [
    {
      ...
      body: [
        ...
        {
          type: "paragraph",
          text: "This Policy applies to two distinct categories of purchases made on the Platform: (a) physical products ordered through the Platform's store; and (b) digital astrological and advisory services accessed through the Platform. The terms applicable to each category are set out separately in the sections below."
        },
        {
          type: "paragraph",
          text: "By placing an order or availing any service on the Platform, you (\"User\", \"Customer\", or \"You\") acknowledge that You have read, understood, and agreed to the terms of this Policy. This Policy must be read in conjunction with the Terms and Conditions of Use, the Privacy Policy, and the Shipping Policy published on the Platform."
        },
        {
          type: "paragraph",
    ...
    {
      heading: "PART A: PHYSICAL PRODUCTS",
      subSections: [
        {
          heading: "2. Eligibility for Returns and Replacements",
          body: [
            {
              type: "paragraph",
              text: "Customers may request a return or replacement of a physical product purchased through the Platform subject to the following conditions:"
            },
            {
              type: "list",
              items: [
                "The return or replacement request must be initiated within seven (7) days of the date of receipt of the product.",
        ...
        },
        {
          ...
          body: [
            {
              type: "paragraph",
              text: "The following items are expressly excluded from the return and replacement policy and are not eligible for return, exchange, or refund under any circumstances:"
            },
            {
              type: "list",
              items: [
                "Products that have been used, worn, washed, or otherwise handled beyond what is necessary to assess their condition;",
        ...
        },
        {
          ...
          body: [
            {
              type: "paragraph",
              text: "Customers wishing to initiate a return must follow the procedure set out below:"
            },
            {
              type: "list",
              items: [
                "Initiation: Contact Veltex customer support at support@astrotring.com with your order number, a description of the issue (defective, damaged, or incorrect item), and clear supporting photographs or video evidence. Return requests must be submitted within seven (7) days of receipt of the product.",
        ...
        {
          heading: "5. Refunds for Physical Products",
          subSections: [
            {
              heading: "5.1 Store Credit Refunds",
              body: [
                {
                  type: "paragraph",
            ...
            {
              heading: "5.2 Refund to Original Payment Method",
              body: [
                {
                  type: "paragraph",
            ...
            {
              heading: "5.3 Defective or Damaged Products",
              body: [
                {
                  type: "paragraph",
                  text: "Where a product is found to be defective or damaged upon delivery and the return is successfully processed, a full Store Credit refund equivalent to the value of the product will be issued to the Customer's account. The Customer may elect to receive the refund to the original payment method subject to deduction of the processing fee described in Section 5.2."
                }
              ]
            },
            {
              heading: "5.4 Partial Returns",
              body: [
                {
                  type: "paragraph",
                  text: "Where a Customer returns only a portion of a multi-item order, a Store Credit equivalent to the value of the specific returned item(s) will be issued. The remaining items in the order will not be affected."
                }
              ]
            },
            {
              heading: "5.5 Replacements",
              body: [
                {
                  type: "paragraph",
        ...
        {
          heading: "6. Quality and Authenticity Guarantee",
          body: [
            {
              type: "paragraph",
    ...
    {
      heading: "PART B: DIGITAL ASTROLOGICAL AND ADVISORY SERVICES",
      subSections: [
        {
          heading: "7. Refunds for Digital Services",
          body: [
            {
              type: "paragraph",
              text: "This Part governs refunds in respect of digital astrological consultations, advisory sessions, and allied services accessed through the Platform. All refund requests in respect of digital services are subject to the following general framework:"
            },
            {
              type: "list",
              items: [
        ...
        {
          heading: "8. Circumstances in Which Refunds May Be Considered",
          body: [
            {
              type: "paragraph",
            ...
            },
            {
              type: "list",
              items: [
                "Technical Disruption: A material disruption to the call or chat session occurred due to weak signal strength, background noise, inaudible audio, or other technical issues that significantly impaired the quality of the consultation.",
                "Language Inability: The Service Provider (Astrologer/Consultant) was unable to communicate fluently in the language stated on their Platform profile, thereby materially affecting the quality of the consultation.",
                "Undue Delay in Response: The Service Provider took an unreasonably long period of time to respond to the User's query during the consultation session, beyond what could reasonably be considered acceptable.",
                "Irrelevant or Inappropriate Response: The Service Provider provided a response that was materially irrelevant, inappropriate, or unrelated to the query posed by the User."
              ]
            },
            {
              type: "paragraph",
        ...
        {
          heading: "9. Circumstances in Which Refunds Will Not Be Granted",
          body: [
            {
              type: "paragraph",
              text: "Notwithstanding the provisions of Section 8, refund requests for digital services will not be entertained in the following circumstances:"
            },
            {
              type: "list",
              items: [
        ...
        {
          heading: "10. Summary of Refund Conditions",
          body: [
            {
              type: "paragraph",
              text: "The following table provides a summary of the applicable refund framework for ease of reference:"
            },
            {
              type: "table",
